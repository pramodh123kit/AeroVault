...
(function() {
    ...
    function applyFilters() {
        ...
        rows.forEach(row => {
            const departmentMatch = department === 'all' || row.querySelector('.department-cell').textContent.includes(department);
            const systemMatch = system === 'all' || row.querySelector('.system-cell').textContent.includes(system);
            const categoryMatch = category === 'all' || row.querySelector('.category-cell').textContent.includes(category);
            
            row.style.display = departmentMatch && systemMatch && categoryMatch ? '' : 'none';
        });
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('.view-icon').forEach(icon => {
            icon.addEventListener('click', () => {
                ...
                console.log('Viewing file:', icon.closest('tr').querySelector('td:first-child').textContent);
            });
        });
    });
})();